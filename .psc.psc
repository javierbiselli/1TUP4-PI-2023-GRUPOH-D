	...
	Repetir
		...
		Segun opcionSeleccionada Hacer
			1:
				...
				OrdenarDescendente(productosCargados, idProducto, ordenarpor)
				MostrarListado(productosCargados, idProducto)
			2:
				
				OrdenarAscendente(productosCargados, idProducto, ordenarpor)
				MostrarListado(productosCargados, idProducto)
			3:
...
Subproceso OrdenarDescendente(productosCargados Por Referencia, idProducto Por Referencia, ordenarpor)
...
Subproceso OrdenarAscendente(productosCargados Por Referencia, idProducto Por Referencia, ordenarpor)
	Definir eleccion Como Entero
	Si idProducto <= 0 Entonces
		Escribir "No hay productos cargados"
	SiNo
